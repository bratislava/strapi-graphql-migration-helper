import { getSdk as localhostGetSdk } from '../graphql/gallery-localhost'
import { getSdk as stagingGetSdk } from '../graphql/gallery-staging'
...
const localhostGalleryClient = new GraphQLClient('http://localhost:1337/graphql')

// We are connecting to dev, because staging is more used for testing purposes and the database is changed more often
const stagingGalleryClient = new GraphQLClient('https://city-gallery-strapi.bratislava.sk/graphql')

export const localhostClient = localhostGetSdk(localhostGalleryClient)
export const stagingClient = stagingGetSdk(stagingGalleryClient)
